 ...
 * item's id.
 *
 * Note: invisible EditText is used ot setError for status.  For whatever reason, we cannot use setError
 * to update the status Switch; so instead an error is set to an "invisible" EditText.
 */
