...
/**
 * Editing a pre-existing contact consists of deleting the old contact
 * and adding a new contact with the old contact's id.
 *
 * Note: we cannot edit contact who are actively borrowing an item
 */
public class EditContactActivity extends AppCompatActivity {
    ...
    public void saveContact(View view) {
        ...
        if (!email_str.contains("@")) {
            email.setError("Must be an email addres!");
            return;
        }
